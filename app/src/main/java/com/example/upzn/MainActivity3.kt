...
class MainActivity3 : AppCompatActivity() {
    ...
    private val originalPosts = listOf(
        ...
        Item(
            id = 2,
            logoResId = R.drawable.logogo,
            title = "В 2025 году отмечается 300-летие Воронежской губернии.",
            date = "23 марта в 15:16",
            imageResId = R.drawable.post11,
            description = "В честь этого важного события мы предлагаем окунуться в историю региона, узнать больше о наших славных земляках и познакомиться с самыми неожиданными фактами о родном крае.\n" +
                    "\n" +
                    "В строительстве военно-морского флота при Петре I на территории Воронежской губернии участвовали не только жители столицы Черноземья. Так, важные работы велись и лискинскими мастерами.\n" +
                    "\n" +
                    "В 1698-1699 гг. икорецким рабочим поручали строить «лесные плоты и фуркаты». Первые помогали сплавлять лес, а вторые были аналогами маленьких галер – приводились в движение парусами и гребцами. Такие суда ходили по Дону и после создания флота. ",
            likeCount = 52,
            shareCount = 6,
            commentCount = 15,
            isLiked = false
        ...
        Item(
            id = 3,
            logoResId = R.drawable.logogo,
            title = "24 марта 2025 года для студентов БТПИТ была организованна и проведена профилактическая встреча с сотрудником ОГИБДД ОМВД России по г. Борисоглебск Семеновой О.А.",
            date = "24 марта в 15:30",
            imageResId = R.drawable.post22,
            description = "В ходе профилактической беседы инспектор по пропаганде ОГИБДД ОМВД России по г. Борисоглебск Семенова Ольга Александровна рассказала студентам об основных причинах дорожно-транспортных происшествий, в том числе с участием несовершеннолетних. Предупредила о недопустимости нарушений Правил дорожного движения, об административной ответственности несовершеннолетних за нарушение ПДД, управление транспортным средством водителями, не имеющим права управления, а также в состоянии алкогольного или наркотического опьянения.\n" +
